...
import me.relaxitsdax.thecaverns.game.guis.types.createitem.TestGUICMD;
...
public final class TheCaverns extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        getServer().getPluginManager().registerEvents(new CreateItemInventoryGUI(null, null, null), this);
        getServer().getPluginManager().registerEvents(new SetRarityInventoryGUI(), this);
        getServer().getPluginManager().registerEvents(new SetBonusesInventoryGUI(), this);
        ...
        getCommand("createitem").setExecutor(new TestGUICMD());
